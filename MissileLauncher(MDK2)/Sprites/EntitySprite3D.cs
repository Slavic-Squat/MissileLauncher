...
namespace IngameScript
{
    ...
    {
        public class EntitySprite3D : Sprite3D
        {
            public EntityInfo EntityInfo { get; private set; }
            public SpriteDefinition Definition { get; private set; }
            public float Scale { get; private set; }

            public EntitySprite3D(EntityInfo entityInfo, SpriteDefinition definition, Vector3 position, float scale, float? rotation = null, Color? color = null)
            {
