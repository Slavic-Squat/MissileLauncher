...
namespace IngameScript
{
    partial class Program
    {
        public static class UIConfig
        {
            ...
            public static Color MenuFillColor = DarkGray1;
            public static Color MenuFillColorActive = DarkGray2;
            public static Color MenuBorderColor = LightGray0;
            public static Color MenuBorderColorActive = Blue0;

            public static Color PanelFillColor = DarkGray1;
            public static Color PanelFillColorHighlighted = DarkGray1;
            public static Color PanelFillColorActive = DarkGray2;
            ...
            public static Color ButtonFillColor = DarkGray2;
            public static Color ButtonFillColorHighlighted = DarkGray2;
            public static Color ButtonFillColorPressed = DarkGray3;
            ...
            public static Color ToggleButtonFillColorReleased = DarkGray2;
            public static Color ToggleButtonFillColorRH = DarkGray2;
            public static Color ToggleButtonFillColorPressed = DarkGray3;
            public static Color ToggleButtonFillColorPH = DarkGray3;
            ...
            public static Color DarkGray0 = new Color(20, 20, 20);
            public static Color DarkGray1 = new Color(32, 32, 32);
            public static Color DarkGray2 = new Color(48, 48, 48);
            public static Color DarkGray3 = new Color(64, 64, 64);
            public static Color LightGray0 = new Color(192, 192, 192);
            public static Color Blue0 = new Color(0, 153, 255);
            public static Color Yellow0 = new Color(255, 208, 0);
            public static Color Red0 = new Color(255, 64, 64);
        }
    }
}
